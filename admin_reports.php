...
if ($db->num_rows($result))
{
	while ($cur_report = $db->fetch_assoc($result))
	{
		...
		$forum = ($cur_report['forum_name'] != '') ? '<span><a href="viewboard.php?id='.$cur_report['forum_id'].'">'.pun_htmlspecialchars($cur_report['forum_name']).'</a></span>' : '<span>'.$lang_admin_reports['Deleted'].'</span>';
