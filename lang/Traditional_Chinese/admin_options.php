...
'Posts per page help'				=>	'一個主題中每頁面默認顯示的文章數目。用戶可自定義該數值。',
'Indent label'						=>	'縮進寬度',
...
'Quick post help'					=>	'啟用後，FluxBB將在主題下添加一個快速發表回覆的表單。通過它用戶便可在查看主題時直接發表回覆。',
...
'Topic views help'					=>	'跟蹤主題被瀏覽的次數。公告板繁忙服務器負載過高時建議禁用。',
...
'Topic subscriptions help'			=>	'允許用戶訂閱主題(主題有新回覆時接收到提醒郵件)。',
...
'Maintenance mode help'				=>	'啟用後，公告板只對管理員開放。該功能用於公告板需要臨時掛起維護之時。<strong>警告！公告板處於維護模式時請勿登出。</strong>那會讓您再也登錄不進來。',
