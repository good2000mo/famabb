...
'Reg email'					=>	'感謝您的註冊。您的密碼已經發送至指定的電子信箱。如未收到請聯繫公告板管理員',
'Reg complete'				=>	'註冊成功。正在登錄並跳轉 …',

// Register info
'Desc 1'					=>	'註冊將賦予您比訪客更多的一些權限和功能。包括擁有編輯和刪除文章的權限，設計顯示於您的文章中的個性簽名等。如果您有任何疑問，您可以聯繫公告板管理員。',
