...
if (isset($_POST['delete']))
{
	...
	if ($is_topic_post)
	{
		...
		redirect('viewboard.php?id='.$cur_post['fid'], $lang_delete['Topic del redirect']);
	}
	else
	{
